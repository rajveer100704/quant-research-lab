...
from backend.src.broker.quant_research_lab_trading_engine.backtester.backtester import Backtester
from backend.src.broker.quant_research_lab_trading_engine.evaluator.evaluator import Evaluator
from backend.src.broker.quant_research_lab_trading_engine.strategies.strategy_factory import (
    StrategyFactory,
)
from backend.src.broker.quant_research_lab_trading_engine.tactician.exchange_interface import (
    TacticianExchangeInterface,
)
from backend.src.broker.quant_research_lab_trading_engine.tactician.strategy_runtime_manager import (
    StrategyRuntimeHandler,
)
from backend.src.broker.quant_research_lab_trading_engine.tactician.tactician_base import Tactician
...
def get_available_strategies():
    STRATEGIES = [
        "Bollinger Bands",
        "[QuantResearchLab] Bollinger Surge",
        "Exponential Moving Average (EMA) crossover",
        "[QuantResearchLab] Impulse Breakout",
        "[QuantResearchLab] Quantum Momentum",
        "RSI",
    ]
    try:
