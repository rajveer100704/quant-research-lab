...
fix_page_layout("QuantResearchLab", "3.8rem")
get_logo_header()
st.caption("Welcome to QuantResearchLab, the current page shows the wallet balances from all connected exchange accounts.")
st.caption(
