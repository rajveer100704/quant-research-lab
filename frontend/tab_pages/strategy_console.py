    ...
    if df_to_show.shape[0] == 0:
        ...
        if logs is not None and len(logs) > 0:
            ...
            st.caption(
                ...
                "Ideally the slippage has to be as close to 0 as it gets. QuantResearchLab defines slippage as ***actual_order_price - desired_price***. Therefore, in case of a **BUY** order a positive value is good and for **SELL** a negative slippage value is better."
            )
